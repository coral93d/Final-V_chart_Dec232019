...
namespace AspNetRoleBasedSecurity.Repository
{
    public class PostRepository
    {
        ...
        public List<FalshModel> Flash_News()
        {
            connection();
            List<FalshModel> PostList = new List<FalshModel>();


            SqlCommand com = new SqlCommand("GetFlash", con);
            com.CommandType = CommandType.StoredProcedure;
        ...
        {
            connection();
            List<test> UserListt = new List<test>();
